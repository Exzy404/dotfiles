 ...
 \  `-"             \'\   / |
  ...
  `--'   `--'
		...
		dashboard.section.buttons.val = {
			...
			dashboard.button("p", "󰗼   Projects", ":Explore ~/projects<CR>"),
			dashboard.button("e", "   File Explorer", ":Explore %:p:h <CR>"),
			dashboard.button("r", "   Recent", ":Telescope oldfiles<CR>"),
			dashboard.button("c", "   Configuration", ":Explore ~/.config/nvim <CR>"),
			dashboard.button("C", "   Classes", ":Explore ~/classes<CR>"),
			dashboard.button("d", "  Dotfiles", ":Explore ~/.config/ <CR>"),
		}
